...
/* Inject Dependencies */
DummyService.$inject = ['$http', '$q', 'AppConstants', 'FormUtils',
 ...
 */
function DummyService($http, $q, AppConstants, FormUtils, Base64,
  SessionService){
...
// Export the module
module.exports = {
  name : 'DummyService', // Change this name
  fn : DummyService // Change this function name
};
